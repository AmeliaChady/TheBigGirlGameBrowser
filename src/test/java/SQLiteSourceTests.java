...
public class SQLiteSourceTests {
    ...
    @Test
    public void SQLiteSourceLoadUser() throws IOException, DataSourceException {
        SQLiteSource.RunSQL(
                DB_BASE_PATH + "LoadUser.db",
                SCRIPT_BASE_PATH + "DDL.sql"
        );
    ...
    @Test
    public void SQLiteSourceSaveAccount() throws IOException, DataSourceException {
        SQLiteSource.RunSQL(
                DB_BASE_PATH + "SaveAccount.db",
                SCRIPT_BASE_PATH + "DDL.sql"
        );

        SQLiteSource.RunSQL(
                DB_BASE_PATH + "SaveAccount.db",
                SCRIPT_BASE_PATH + "Test_SQLiteSource/SaveAccount.sql"
        );

        SQLiteSource s = new SQLiteSource(DB_BASE_PATH+ "SaveAccount.db");
    ...
    @Test
    public void SQLiteSourceSaveReviews() throws IOException, DataSourceException {
        SQLiteSource.RunSQL(
                DB_BASE_PATH + "SaveReviews.db",
                SCRIPT_BASE_PATH + "DDL.sql"
        );
        SQLiteSource.RunSQL(
                DB_BASE_PATH + "SaveReviews.db",
                SCRIPT_BASE_PATH + "Test_SQLiteSource/SaveReviews.sql"
        );
        SQLiteSource s = new SQLiteSource(DB_BASE_PATH + "SaveReviews.db");
        DataSourceTest.dataSourceSaveReviewsTest(s);
        s.close();
    }
}
