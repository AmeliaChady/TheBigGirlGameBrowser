...
public class UISprint1 {
    ...
    public UISprint1(String filepath) throws IllegalArgumentException, DataSourceException {
        // This should be a DB specific to UI or MAIN
    ...
    private void login() throws DataSourceException {
        ...
        if (roleChoice == 1) {
            //adminTakeAction();
            System.out.println("Admin is under rennovations and will return to you soon");
            login();
...
//            // TODO if (gameBrowser.getGameList().getGamesGivenStatus(Status.ACCEPTED).getGameCount()>0){
//            if(1==2)
...
//    }
    ...
    public void includeGame(Game game) throws DataSourceException {
        gameBrowser.addGame(game);
    }

    public void removeGame(String title) throws DataSourceException {
